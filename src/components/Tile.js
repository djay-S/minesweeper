...
export default class Tile extends Component {
    ...
    onInputChange = () => {
        ...
        this.props.handleInput(this.state.rows, this.state.columns, this.state.mines)
    }
        ...
        return (
            <span className='tile'>
                ...
                <button name={this.props.name} onClick={this.gameSelected}>
                    <br />
                    <br />
                    <img src='http://bgfons.com/uploads/tile/tile_texture3062.jpg' alt={this.props.name} />
                </button>
            </span>
        )
    }
